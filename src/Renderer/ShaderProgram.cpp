...
namespace RenderEngine {
	ShaderProgram::ShaderProgram(const std::string& vertexShander, const std::string& fragmentShander)
	{
		...
		if (!creadShader(vertexShander, GL_VERTEX_SHADER, vertexShaderID))
		{
			std::cerr << "VERTEX SHADER compile time trror" << std::endl;
			return;
		}
	...
	bool ShaderProgram::creadShader(const std::string& sourse, GLenum shaderType, GLuint& shaderID)
	{
	...
	//для определения глубины в шейдере..
