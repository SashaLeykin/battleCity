															 ...
															 const float rotation)
{
	...
	{
    case '0':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_right"), position, size, rotation);
    case '1':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_bottom"), position, size, rotation);
    case '2':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_left"), position, size, rotation);
    case '3':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_top"), position, size, rotation);
    case '4':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall"), position, size, rotation);
    case 'G':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_bottom_left"), position, size, rotation);
    case 'H':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_bottom_right"), position, size, rotation);
    case 'I':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_top_left"), position, size, rotation);
    case 'J':
        return std::make_shared<BrickWall>(ResourceMenager::getSprite("brickWall_top_right"), position, size, rotation);
    case 'D':
        return nullptr;
    default:
