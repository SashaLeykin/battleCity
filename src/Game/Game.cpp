...
bool Game::init()
{
    ...
    //инициализация танка 
    m_pTank = std::make_unique<Tank>(ResourceMenager::getSprite("tankSprite_top"),
                                     ResourceMenager::getSprite("tankSprite_bottom"),
                                     ResourceMenager::getSprite("tankSprite_left"),
                                     ResourceMenager::getSprite("tankSprite_right"),
